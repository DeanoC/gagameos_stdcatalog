...
static_assert(sizeof(DIR) == 88);
static_assert(sizeof(FILINFO) == 288);
...
static_assert((sizeof(DIR) + sizeof(FATFS_DirectoryEnumeratorItem) + sizeof(FILINFO)) == FATFS_SIZEOF_DIRECTORYENUMERATOR);
